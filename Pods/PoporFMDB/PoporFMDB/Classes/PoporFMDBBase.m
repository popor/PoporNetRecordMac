...
- (id)init {
    if (self = [super init]) {
        ...
        self.DBPath      = [NSString stringWithFormat:@"%@/%@", self.cachesPath, VCDBFileName];
        
        [[NSFileManager defaultManager] createDirectoryAtPath:self.cachesPath withIntermediateDirectories:YES attributes:nil error:nil];
